        ...
        <section className="guided-workflow-panel">
          {activeStep === "RUN_SETUP" ? (
            <article className="guided-workflow-card guided-workflow-card--hero">
              ...
              <p>
                The business receives messy golf trade-in information from different
                operational sources. The workflow should turn that messy input into
                structured records, run a controlled AI workflow, and explain what happened.
              </p>

              <h4>What to understand before moving on</h4>
              <p>
                This is not a chatbot demo. It is an operations workflow: intake,
                normalization, guarded execution, validation, review, and final output.
              </p>
