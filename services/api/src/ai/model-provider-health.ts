...
export type ModelProviderHealthStatus = "HEALTHY" | "DEGRADED" | "UNAVAILABLE";
...
> = {
  ...
  ANTHROPIC: {
    ...
    reason:
      "Anthropic is intentionally marked degraded to demonstrate fallback routing.",
  },
  AZURE_OPENAI: {
    ...
    reason:
      "Azure OpenAI route is healthy and available as an enterprise fallback.",
  },
  OLLAMA: {
    provider: "OLLAMA",
    status: "HEALTHY",
    ...
    reason:
      "Local/self-hosted Ollama route is healthy for privacy-sensitive tasks.",
  },
};
