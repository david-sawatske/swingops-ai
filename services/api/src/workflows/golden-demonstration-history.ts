...
export const GOLDEN_DEMONSTRATION_HISTORY_IDS = {
  ...
  aiReadySupersededRecordId: "golden_demo_history_ai_ready_previous",
  aiReadyReplacementRecordId: "golden_demo_history_ai_ready_replacement",
} as const;
...
export async function ensureGoldenDemonstrationHistory(): Promise<GoldenDemonstrationHistoryResult> {
  return prisma.$transaction(async (tx) => {
    ...
    await tx.aiReadyIntakeRecord.upsert({
      where: {
      ...
      create: {
        id: GOLDEN_DEMONSTRATION_HISTORY_IDS.aiReadyReplacementRecordId,
        workflowRunId: GOLDEN_DEMONSTRATION_HISTORY_IDS.workflowRunId,
        sourceRecordId: "historical-ping-g425-reviewed",
        sourceType: "FREE_TEXT",
        sourceName: "Historical reviewed counter intake",
        rawText: HISTORICAL_SOURCE_TEXT,
        cleanedText: HISTORICAL_SOURCE_TEXT,
        normalizedJson: {
          id: "historical-ping-g425-reviewed",
          sourceId: "historical-review-source",
          sourceType: "FREE_TEXT",
          brand: "PING",
          productLine: "G425",
          category: "IRON_SET",
    ...
    await tx.aiReadyIntakeRecord.upsert({
      ...
      create: {
        id: GOLDEN_DEMONSTRATION_HISTORY_IDS.aiReadySupersededRecordId,
        workflowRunId: GOLDEN_DEMONSTRATION_HISTORY_IDS.workflowRunId,
        sourceRecordId: "historical-ping-g425-previous",
        sourceType: "FREE_TEXT",
        sourceName: "Historical counter intake",
        rawText: HISTORICAL_SOURCE_TEXT,
        cleanedText: HISTORICAL_SOURCE_TEXT,
        normalizedJson: {
          id: "historical-ping-g425-previous",
          sourceId: "historical-review-source",
          sourceType: "FREE_TEXT",
          brand: "PING",
          productLine: "G425",
        ...
        qualitySignalsJson: [
          {
            ...
            severity: "WARNING",
            message: "The earlier candidate did not contain shaft flex.",
          },
        ],
        status: "SUPERSEDED",
        reviewNeeded: true,
        ...
        supersededAt: HISTORICAL_REVIEW_DATE,
        supersededReason:
          "Human review confirmed that “shaft firm” means STIFF, so the corrected record replaced this earlier candidate.",
        createdAt: new Date("2026-06-30T14:55:00.000Z"),
      },
      update: {
        workflowRunId: GOLDEN_DEMONSTRATION_HISTORY_IDS.workflowRunId,
        sourceRecordId: "historical-ping-g425-previous",
